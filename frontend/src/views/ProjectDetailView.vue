...
const architectureNodes = computed<ProjectArchitectureNode[]>(() => architectureAvailable.value ? [
  { id: 'client', label: 'Vue3 / Tailwind CSS', caption: 'Public interface', tone: 'brand' },
  { id: 'api', label: 'Spring Boot 3', caption: 'HTTP API', tone: 'accent' },
  { id: 'database', label: 'MySQL 8', caption: 'Primary storage', tone: 'neutral' },
...
function applyProjectSeo(value: ProjectDetail) {
  ...
  cleanupSeo = applySeo({
    title: `${value.name} | Projects | YU.LOG`,
    description,
  ...
  <PublicLayout>
    <div class="project-detail-page">
      ...
      <section v-else-if="fatalError" class="project-unavailable">
        <p class="font-mono text-[0.65rem] uppercase tracking-[0.15em] text-brand">Project unavailable</p>
        <h1>这一页暂时读不到</h1>
        <p>{{ fatalError }}</p>
      ...
      <article v-else-if="project">
        <header class="project-hero">
          <RouterLink class="project-back" :to="backTo">← Back to projects</RouterLink>
          <div class="project-hero__meta">
            <p class="font-mono text-[0.65rem] uppercase tracking-[0.15em] text-brand">Project // {{ projectNumber }} · Case study</p>
          ...
          <div class="project-hero__facts">
            ...
            <span v-if="project.updatedAt">Updated {{ formatDate(project.updatedAt) }}</span>
          ...
          <div v-if="githubUrl || demoUrl" class="project-hero__links">
            ...
            <a v-if="demoUrl" :href="demoUrl" target="_blank" rel="noreferrer">Live demo <span aria-hidden="true">↗</span></a>
          </div>
        </header>
        ...
        <div class="project-reading-grid">
          <div class="project-reading-content">
            <section v-if="project.description" class="project-section" aria-labelledby="project-context-title">
              <p class="project-kicker">Context / intent</p>
              <h2 id="project-context-title">What this project is for</h2>
            ...
            <section v-if="detailText" class="project-section project-notes" aria-labelledby="project-notes-title">
              <p class="project-kicker">Project notes</p>
              <h2 id="project-notes-title">What I am carrying forward</h2>
